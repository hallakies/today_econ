...
- **콘텐츠**: 표지 훅 → 검증된 핵심 사실 → 독자 유형별 영향 → 전망 2개와 오늘의 확인 행동으로 이어지는 4장 구조입니다.
- **품질 게이트**: 문장 길이, 카드 내 중복, 하이라이트, 과장 표현, 수치의 기사 근거, 캡션 질문을 검사하며 80점 미만은 게시하지 않습니다.
- **디자인**: Instagram 피드 캐러셀 권장 비율인 4:5(1080×1350), Pretendard, 단일 에디토리얼 테마를 사용합니다.
