...
function highlightText(text, themeColor) {
  ...
  processed = processed.replace(/<hl>(.*?)<\/hl>/gi, `<span class="font-black text-primary" style="color: ${themeColor}; font-weight: 900; text-shadow: 0 0 10px ${themeColor}20;">$1</span>`);
...
function renderObsidian(cardType, content, imageBase64, themeColor) {
  ...
  if (cardType === 'title') {
    ...
    const bulletsHtml = content.bullets
      .map(bullet => `
        <li class="flex items-center gap-6 py-6">
