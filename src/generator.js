...
8. **콘텐츠 중복 절대 금지 규칙 (CRITICAL)**:
   ...
   - 각 영역은 반드시 아래와 같이 완전히 독립적인 관점과 깊이의 원고로 구성되어야 합니다:
     - 'card1.title' 및 'card1.editors_insight': 핵심 사실 브리핑과 호기심 유발.
     - 'card2.bullets' 및 'card2.editors_insight': 기사 속에 언급된 가장 중요한 핵심 지표/팩트(금액, 규모, 일정, 당사자) 중심 요약.
     - 'card3.bullets' 및 'card3.editors_insight': 독자가 실제로 활용할 수 있는 현실적이고 구체적인 액션 아이템/전략(예: 대출 상품 금리비교 사이트 접속, 보증 펀드 신청 조건 확인, 정부 포털에서 신청서 양식 조회 등).
     - 모든 'editors_insight'는 해당 페이지의 타이틀이나 불릿 포인트를 그대로 똑같이 반복 요약하지 말고, 한 단계 더 나아간 전문적인 에디터 평론이나 전망을 담으세요.
...
### 응답 JSON 스키마:
{
  ...
  "card3": {
    ...
    "bullets": [
      "15자 내외 행동 유도 CTA 1 (예: 고금리 예적금 막차, 당장 가입하세요!)",
      "15자 내외 행동 유도 CTA 2 (예: 고정금리 대환 수수료부터 확인해볼 것!)",
      "15자 내외 행동 유도 CTA 3 (예: 미국 장기채 ETF 분할 매수 타이밍입니다)"
    ],
    "editors_insight": "대책에 대한 행동 유도 에디터 평 (예: 대출 갈아타기 타이밍을 당장 모니터링하세요!)",
    "image_prompt": "FLUX 이미지 생성용 영어 프롬프트"
  },
