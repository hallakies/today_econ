...
2. 기사의 파급성, 특히 **20~30대 직장인과 재테크 초보의 지갑(대출 금리 인하, 부동산 청약, 물가 상승, 세금 감면 등 실생활 직접 타격)**에 즉각적인 영향을 주는 뉴스를 무조건 1순위로 선정하세요. 국가 간 무역 협정(CEPA), 거시적 외교, 단순 MOU 체결 등 개인의 지갑과 거리가 먼 뉴스는 철저히 배제하세요.
3. **[CRITICAL] 특정 기업/기관 내부의 인사(HR), 조직 개편, 부고 등 임직원 전용 소식은 일반인의 재테크와 무관하므로 절대 선정하지 마십시오.**
4. 결과를 정확히 JSON 포맷으로 응답해야 합니다.
